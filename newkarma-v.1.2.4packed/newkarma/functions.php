...
if ( ! function_exists( 'gmr_scripts' ) ) :
	...
	function gmr_scripts() {
		...
		// Add stylesheet.
		wp_enqueue_style( 'newkarma-style', get_stylesheet_uri(), '', NEWKARMA_VER );

		if ( newkarma_is_amp() ) {
			wp_enqueue_style( 'newkarma-amp', get_template_directory_uri() . '/style-amp.css', array( 'newkarma-style' ), NEWKARMA_VER );
		}
